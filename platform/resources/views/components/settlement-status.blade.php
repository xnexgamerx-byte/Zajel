...
@php
    [$label, $classes] = match ($status) {
        'draft'     => ['مسوّدة', 'bg-amber-50 text-amber-800 ring-amber-200'],
        'confirmed' => ['مُقفَل', 'bg-sky-50 text-sky-700 ring-sky-200'],
        'paid'      => ['مدفوع', 'bg-emerald-50 text-emerald-700 ring-emerald-200'],
