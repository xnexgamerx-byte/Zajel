...
<div class="mx-auto mt-16 w-full max-w-sm">
    <div class="mb-6 text-center">
        <div class="mx-auto mb-3 grid h-14 w-14 place-items-center rounded-2xl bg-slate-900 text-2xl font-black text-white">ز</div>
        <h1 class="text-xl font-bold">إدارة منصّة زاجل</h1>
        <p class="mt-1 text-sm text-slate-500">دخول مدراء المنصّة فقط</p>
    </div>
